 ...
 * garbage-collected. All plan outputs (FIT workout, course GPX, course FIT,
 * plan JSON) are built on the main thread and saved through here.
 *
 ...
 */
export function downloadBlob(filename: string, data: BlobPart | Uint8Array, mime: string): void {
